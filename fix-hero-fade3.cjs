...
content = content.replace(
  /\<div className=\{\`absolute top-1\/2 left-1\/2 -translate-x-1\/2 -translate-y-1\/2 w-\[120%\] h-\[150%\] rounded-\[100%\] blur-\[80px\] pointer-events-none -z-10 \$\{theme === "dark" \? "" : "bg-white\/40"\}\`\}\>\<\/div\>/,
